...
/*   Updated: 2023/05/18 19:28:18 by takira           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	t_vec	vec_origin2pe;
	t_vec	vec_cross_de_axis;
	t_vec	vec_cross_origin2pe_axis;
	...
	double	dot_de_axit;
	double	dot_origin2pe_axis;
	double	vec_norm_de_x_axis;
	double	norm_cross_origin2pe_x_axis;
};
